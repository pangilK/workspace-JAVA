...
public class BookManagement {
	...
	public void  registerBook() {
		...
		books[count].title = scanLine.next();
		System.out.println("등록할 책의 저자를 입력하세요 >");
		books[count].author = scanLine.next();
		System.out.println("등록 완료");
		books[count].num = count;
		count++;
	}
	...
	public void updateBook() {
		...
		int booksNum = scanLine.nextInt();
		findBook(booksNum);
		printBookInfo(books[booksNum]);
		a  : while(true) {
			System.out.println("==================================");
